...
test.describe("Base de Datos (KET-45)", () => {
  ...
  // [W0.12] Antes habia dos entradas por cliente y las altas iban contra la editable. Desde el
  // rename del 24/08 hay una sola entrada por cliente, y es editable.

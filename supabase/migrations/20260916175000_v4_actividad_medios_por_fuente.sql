-- [W0.23d] La identidad operacional es la fuente. Un dominio puede tener secciones distintas.

begin;

alter table test.v4_run_medios drop constraint if exists v4_run_medios_pkey;
alter table test.v4_run_medios alter column fuente_id set not null;
alter table test.v4_run_medios add primary key (run_id, fuente_id);
